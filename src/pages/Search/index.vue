...
export default {
  ...
  beforeMount() {
    ...
    this.searchParams.keyword = this.$route.params.keywod;
    //  Object.assign利用es6语法合并对象
  ...
  methods: {
    ...
    trademarkInfo(trademark) {
      // 从子组件传过来的trademark赋给data的trademark
